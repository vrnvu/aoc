...
fn run_solution(year: &str, day: &str, data: &str) -> (String, String) {
    ...
    match (year, day) {
        ...
        (Year::Year2015, Day::Day06) => year2015::day06::run(data),
        (Year::Year2015, Day::Day07) => year2015::day07::run(data),
        (Year::Year2015, Day::Day08) => year2015::day08::run(data),
        (Year::Year2015, Day::Day09) => year2015::day09::run(data),
        (Year::Year2015, Day::Day10) => year2015::day10::run(data),
        (Year::Year2015, Day::Day11) => year2015::day11::run(data),
        (Year::Year2015, Day::Day12) => year2015::day12::run(data),
